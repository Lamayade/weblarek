...
– задание значения нахождения товара в корзине. При задании обновляется текст кнопки.

```ts
private updateButtonState()
```

– Внутренний метод, обновляющий текст и доступность кнопки в зависимости от состояния 
полей <i>_isInCart</i> и <i>_isAvailable</i>.